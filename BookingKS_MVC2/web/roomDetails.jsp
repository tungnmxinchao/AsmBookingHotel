<%-- 
    ...
    Created on : Jun 19, 2024, 9:38:28 PM
    Author     : TNO
--%>
                ...
                <div class="row">
                        ...
                        <div class="room-details-item">
                            ...
                            <div id="roomCarousel" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="img/room/room-details.jpg" class="d-block w-100" alt="Room Image 1">
                                    </div>
                                    <c:forEach items="${roomImage}" var="roomImage">
                                        <div class="carousel-item">
                                            <img src="${roomImage.image}" class="d-block w-100" alt="Room Image ${roomImage.id}">
                                        </div>
                                    </c:forEach>
                            ...
                            <div class="rd-text">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="r-o">Adult Amount:</td>
                                            <td>${room.adultAmount}</td>
                                        </tr>
                                        <tr>
                                            <td class="r-o">Childrent Amount:</td>
                                            <td>${room.childAmount}</td>
                                        </tr>
                                        <tr>
                                            <td class="r-o">Hotel Name:</td>
                                            <td>${room.hotelName}</td>
                                        </tr>
                                        <tr>
                                            <td class="r-o">Address:</td>
                                            <td>${room.address} , Contact: ${room.phone}</td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-lg-4">
                        <div class="room-booking">
                            ...
                            <form action="room?action=bookingRoom" method="post">
